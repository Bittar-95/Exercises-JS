...
var adjective2 = 'fun';
var adjective3 = 'entertaining';
var madLib = 'The Intro to JavaScript course is '+adjective1+'. James and Julia are so '+adjective2+'. I cannot wait to work through the rest of this '+adjective3+' content! Directions Mad Libs is a word game where players have fun substituting words for blanks in a story.';
// your code goes here
console.log(madLib);
